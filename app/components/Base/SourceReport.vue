...
import { type Report, type DayRow } from '#shared/reconciliation'
import { formatMoney, formatDate } from '~/utils/format'
const props = defineProps<{ report: Report; stale: boolean; busy: boolean; exporting: boolean }>()
defineEmits<{ excel: []; print: []; detail: [row: DayRow] }>()
...
<template>
  ...
  <BaseRevenueChart :rows="report.rows" :source="source" @detail="$emit('detail', $event)" />
